...
High level description of SNP distribution across genome
...
A distribution of the SNPs across the genome using the data from all 7 patients
...
Number of SNPs for each patient
